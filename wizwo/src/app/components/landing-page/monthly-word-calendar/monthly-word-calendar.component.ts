...
import { DailyWordCardComponent } from './daily-word-card/daily-word-card.component';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, DailyWordCardComponent, CardModule],
...
export class MonthlyWordCalendarComponent {
  ...
  nextPage() {
    if(this.currentPage * this.wordsPerPage < this.words.length) {
      this.currentPage++;
    }
  }
